    ...
    <div class="item signin-btn-item">
        <div class="ui grid">
            <div class="column tablet computer only">
                <div class="ui buttons">
                    <button 
                        ...
                        class="<?php echo esc_attr($login_page && $login_link_desktop == 1 ? 'signup-btn-link ' : 'signup-btn ') ?> ui <?php echo esc_attr( strtoupper($header_menu_color) != '#FFFFFF' ? 'inverted ' : 'green signup-btn-style ') ?>button"
                        data-id="">
                    ...
                    <button 
                        ...
                        class="<?php echo esc_attr($login_page && $login_link_desktop == 1 ? 'signin-btn-link ' : 'signin-btn ') ?>ui <?php echo esc_attr( strtoupper($header_menu_color) != '#FFFFFF' ? 'inverted ' : 'primary ') ?>button"
                        data-id="">
            ...
            <div class="column mobile only">
                <?php get_template_part('templates/header/part/login-button-mobile', 'app') ?>
            </div>
        </div>
    </div>
<?php } ?>